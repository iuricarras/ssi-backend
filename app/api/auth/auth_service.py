...
class AuthService:
    ...
    def verify_signature(self, email: str, challenge_id: str, signature_base64: str, public_key_pem: str) -> Dict[str, Any]:
        """
        Verifica a assinatura do nonce usando a chave pública do usuário.
        
        *NOTA DE SEGURANÇA*: Em produção, a 'public_key_pem' deve ser recuperada 
        do banco de dados (users) com base no 'email' e não enviada pelo cliente.
        """
        now = datetime.utcnow()
